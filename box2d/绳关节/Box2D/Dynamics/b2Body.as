...
public class b2Body
{
	...
	*/
	...
	private var _preSolveCallback:Function;//function (contact:b2Contact, oldManifold:b2Manifold):void;
	...
	public function RunPreSolveCallback(contact:b2Contact, oldManifold:b2Manifold):void{_preSolveCallback && _preSolveCallback(contact,oldManifold);}
	
	private var _contactBeginCallback:Function;//function (contact:b2Contact):void;
	...
	public function RunContactBeginCallback(contact:b2Contact):void{_contactBeginCallback && _contactBeginCallback(contact);}
	
	private var _postSolveCallback:Function;//function (contact:b2Contact, impulse:b2ContactImpulse):void;
	...
	public function RunPostSolveCallback(contact:b2Contact, impulse:b2ContactImpulse):void{_postSolveCallback && _postSolveCallback(contact,impulse)}
	
	private var _contactEndCallback:Function;//function (contact:b2Contact):void;
	/** value = function (contact:b2Contact):void;*/
	public function SetContactEndCallback(value:Function):void{_contactEndCallback = value;}
	public function RunContactEndCallback(contact:b2Contact):void{_contactEndCallback && _contactEndCallback(contact);}
	...
	/**设置自定义重力*/
	public function SetCustomGravity(v2:b2Vec2):void{m_customGravity=v2;}
