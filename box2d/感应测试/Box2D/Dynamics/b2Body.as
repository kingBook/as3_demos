...
public class b2Body
{
	...
	*/
	public function SetLinearVelocity(v:b2Vec2,awake:Boolean=true) : void {
	...
	*/
	...
	private var _preSolveCallback:Function;//function (contact:b2Contact, oldManifold:b2Manifold, other:b2Body):void;
	/** value = function (contact:b2Contact, oldManifold:b2Manifold, other:b2Body):void;*/
	public function SetPreSolveCallback(value:Function):void{_preSolveCallback=value;}
	public function RunPreSolveCallback(contact:b2Contact, oldManifold:b2Manifold, other:b2Body):void{_preSolveCallback && _preSolveCallback(contact,oldManifold,other);}
	
	private var _contactBeginCallback:Function;//function (contact:b2Contact, other:b2Body):void;
	/** value = function (contact:b2Contact, other:b2Body):void;*/
	public function SetContactBeginCallback(value:Function):void{_contactBeginCallback = value;}
	public function RunContactBeginCallback(contact:b2Contact, other:b2Body):void{_contactBeginCallback && _contactBeginCallback(contact,other);}
	
	private var _postSolveCallback:Function;//function (contact:b2Contact, impulse:b2ContactImpulse, other:b2Body):void;
	/** value = function (contact:b2Contact, impulse:b2ContactImpulse, other:b2Body):void*/
	public function SetPostSolveCallback(value:Function):void{_postSolveCallback=value;}
	public function RunPostSolveCallback(contact:b2Contact, impulse:b2ContactImpulse, other:b2Body):void{_postSolveCallback && _postSolveCallback(contact,impulse,other)}
	
	private var _contactEndCallback:Function;//function (contact:b2Contact, other:b2Body):void;
	/** value = function (contact:b2Contact, other:b2Body):void;*/
	public function SetContactEndCallback(value:Function):void{_contactEndCallback = value;}
	public function RunContactEndCallback(contact:b2Contact, other:b2Body):void{_contactEndCallback && _contactEndCallback(contact,other);}
	
	public function GetAABB():b2AABB{
		var aabb:b2AABB;
		var fixture:b2Fixture=m_fixtureList;
		for(fixture; fixture; fixture=fixture.GetNext()){
			if(!aabb)aabb=fixture.GetAABB().Copy();
	...
	/**设置自定义重力*/
	public function SetCustomGravity(v2:b2Vec2,isAwake:Boolean=true):void{
		m_customGravity=v2; 
		SetAwake(isAwake);
	}
	public function GetCustomGravity():b2Vec2{return m_customGravity;}
	
	public var m_isIgnoreFrictionX:Boolean;
	/**忽略横向平面上摩擦*/
	public function SetIsIgnoreFrictionX(value:Boolean):void{m_isIgnoreFrictionX=value;}
	public function IsIgnoreFrictionX():Boolean{return m_isIgnoreFrictionX;}
	
	public var m_isIgnoreFrictionY:Boolean;
	/**忽略竖直平面上摩擦*/
	public function SetIsIgnoreFrictionY(value:Boolean):void{m_isIgnoreFrictionY=value;}
	public function IsIgnoreFrictionY():Boolean{return m_isIgnoreFrictionY;}
	
	public var m_allowBevelSlither:Boolean;
	/**允许在斜面上滑动*/
	public function SetAllowBevelSlither(value:Boolean):void{m_allowBevelSlither=value;}
	public function GetAllowBevelSlither():Boolean{return m_allowBevelSlither;}
	
	public var m_uphillZeroFriction:Boolean;
	/**上坡无摩擦*/
	public function SetUphillZeroFriction(value:Boolean):void{ m_uphillZeroFriction = value; }
	public function GetUphillZeroFriction():Boolean{ return m_uphillZeroFriction; }
	
	public var m_allowMovement:Boolean;
	/**允许移动*/
	public function SetAllowMovement(value:Boolean):void{ m_allowMovement=value; }
	public function GetAllowMovement():Boolean{ return m_allowMovement; }
	
	public function SetInertiaScale(value:Number):void{m_inertiaScale = value;}
	
	public function Destroy():void{
		if(m_world)m_world.DestroyBody(this);
	}
	...
	*/
	public function ApplyAngularImpulse(impulse:Number,wake:Boolean):void{
		if (m_type != b2_dynamicBody){
			return;
		}
