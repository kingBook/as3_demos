...
public class b2AABB
{
	...
	*/
	...
	public function toString(pixelToMeter:Number=1):String{
		return "lowerBound:"+lowerBound.toString(pixelToMeter)+" upperBound:"+upperBound.toString(pixelToMeter);
	}
	
	public function ToRect(pixelToMeter:Number=1):Rectangle{
		var x:Number=lowerBound.x*pixelToMeter;
		var y:Number=lowerBound.y*pixelToMeter;
		var w:Number=(upperBound.x-lowerBound.x)*pixelToMeter;
		var h:Number=(upperBound.y-lowerBound.y)*pixelToMeter;
